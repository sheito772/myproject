...
# お使いのものを入力してください
DEFAULT_FROM_EMAIL = 'tdn2430041@stu.o-hara.ac.jp'  # メールの送信元のアドレスを入力
EMAIL_HOST = 'smtp-mail.outlook.com'            # GmailのSMPTサーバー　　　
EMAIL_PORT = 587                         # SMPTサーバーのポート番号
EMAIL_HOST_USER = 'tdn2430041@stu.o-hara.ac.jp'     # mailのアドレスを入力
EMAIL_HOST_PASSWORD = 'Oshi124233' # Gmailのアプリ用パスワードを入力
